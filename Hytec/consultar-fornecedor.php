...
<body>
	...
	$sql = "SELECT razaoSocial,cnpj,telefone FROM fornecedor;";
		...
		<div class="card  m-5 shadow-lg rounded-5" id="container">
			...
			<div class="p-2" id="containerResultado">
				...
				<div class="row g-3 needs-validation d-flex justify-content-center">
					<h1 class="text-center my-5 text-dark">Consultar Fornecedores</h1>
	...
	<script src="js/consultar-fornecedor.js"></script>
