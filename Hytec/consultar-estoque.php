...
<body>
		...
		<div class="card  m-5 shadow-lg rounded-5" id="container">
			...
			<div class="p-2" id="containerResultado">
				...
				<div class="row g-3 needs-validation d-flex justify-content-center">
					<h1 class="text-center my-5 text-dark">Consultar Estoque</h1>
					...
					<table id="table" class="bg-light" data-toggle="table" data-filter-control="true" data-click-to-select="true" data-toolbar="#toolbar" data-buttons-prefix="btn" data-footer-formatter="teste" data-show-footer="true" data-show-print="true" data-mobile-responsive="true" data-show-columns="true" data-show-refresh="true" data-show-pagination-switch="true" data-show-toggle="true" data-buttons="buttons" data-show-export="true">
						<thead>
							<tr>
								...
								<th class="text-dark" data-field="peca" data-alignment-select-control-options="auto" data-filter-control="select" data-searchable="true">Peça</th>
								<th class="text-dark" data-field="fornecedor" data-alignment-select-control-options="auto" data-filter-control="select" data-sortable="true">Fornecedor</th>
								<th class="text-dark" data-field="quantidade" data-alignment-select-control-options="auto" data-filter-control="select" data-alignment-select-control-options="right">Quantidade</th>
								<th class="text-dark" data-field="valor" data-alignment-select-control-options="auto" data-filter-control="select" data-footer-formatter="ValorTotal">Valor</th>
							</tr>
						</thead>
						<tbody>
						...
						<?php
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
										...
										<td class='text-dark'>$razaoSocial</td>
										<td class='text-dark text-center'>$quantidade</td>
										<td class='text-dark text-center'>R$$precoUnitario</td>
									</tr>";
                                    }
                                }
                                ?>
	...
	<script src="js/consultar-estoque.js"></script>
